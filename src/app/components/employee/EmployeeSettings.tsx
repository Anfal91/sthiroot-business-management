...
export function EmployeeSettings() {
  ...
  const [formData, setFormData] = useState({
    name: 'Amit Sharma',
    email: 'amit.sharma@sthiroot.com',
    phone: '9876543211',
  ...
  const [profilePhotoPreview, setProfilePhotoPreview] = useState<string>('https://api.dicebear.com/7.x/avataaars/svg?seed=Amit');
  ...
  const removeProfilePhoto = () => {
    ...
    setProfilePhotoPreview('https://api.dicebear.com/7.x/avataaars/svg?seed=Amit');
  };
